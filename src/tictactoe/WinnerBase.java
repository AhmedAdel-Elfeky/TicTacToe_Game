...
public class WinnerBase extends Pane {
    ...
    public WinnerBase(ClientPlayer client) {
        ...
        label.setLayoutX(283.0);
        label.setLayoutY(29.0);
        label.setPrefHeight(93.0);
        label.setPrefWidth(334.0);
        ...
        button0.setLayoutX(498.0);
        button0.setLayoutY(596.0);
