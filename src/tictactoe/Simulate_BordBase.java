...
public class Simulate_BordBase extends BorderPane {
    ...
    public Simulate_BordBase(ClientPlayer client) {
        ...
        button8.setAccessibleRole(javafx.scene.AccessibleRole.TOGGLE_BUTTON);
        button8.setLayoutX(55.0);
        button8.setLayoutY(625.0);
        button8.setMaxHeight(Double.MAX_VALUE);
        button8.setMaxWidth(Double.MAX_VALUE);
        button8.setMnemonicParsing(false);
        button8.setPrefHeight(49.0);
        button8.setPrefWidth(146.0);
        ...
        button8.setOnAction(new EventHandler<ActionEvent>() {
            ...
            {
                client.setGameRoot("profile");
            }
        });

        dropShadow8.setColor(javafx.scene.paint.Color.valueOf("#a731a7"));
        dropShadow8.setSpread(0.6);
